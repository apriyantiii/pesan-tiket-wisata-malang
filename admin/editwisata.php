                        ...
                        <div class="card border-info mb-3" style="width: 27rem;">
                            <div class="card-body bg-light">
                                ...
                                <div class="form-group">
                                    <div class="col-md-55">
                                        <label>Foto</label>
                                        <input type="file" name="foto" default = "$fotoawal" value="<?php echo $wisata['foto'] ?>"  class="form-control" enctype="multipart/form-data" required="" placeholder="Masukkan Foto Tempat Wisata">
                                    </div><br>
                                </div>
