        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    <a href="beranda3.php"><button type="button" class="btn btn-primary">Home</button></a>
                    <a href="informasi.php"><button type="button" class="btn btn-primary">Informasi Wisata</button></a>
    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <br>
                <h1>Tiket Wisata Pantai</h1><br>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <div class="card">
                    <img src="balekambang.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card">
                    <img src="tigawarna.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <br><br><br>
            ...
            <div class="col">
                <div class="card">
                    <img src="telukasmara.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <br><br>
                        <h5 class="card-title">Pantai Teluk Asmara</h5>
                        <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        <a href="#" class="btn btn-primary btn-center">Pesan Tiket</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card">
                    <img src="sendangbiru2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <br>
            ...
            <div class="col">
                <div class="card">
                    <img src="goacina.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <br>
