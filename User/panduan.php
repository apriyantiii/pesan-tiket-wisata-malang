...
<body>
    ...
    <!-- Panduan Menggunakan Card pada Bootstrap -->
    <div class="container">
        <div class="row">
            <header>
                <br>
                <h3 class="alert alert-primary text-center" width="200px">
                    <p class="text-dark">Panduan Pemesanan Tiket</p>
                </h3>
            </header>
        </div><br>
        ...
        <div class="row">
            <div class="col">
                <div class="card text-center">
                    <div class="card-header text-light" style="background: #1D3283;">
                        <strong>Langkah 1</strong>
                    </div>
                    <div class="card-body">
                        <i class='fas fa-map-marked-alt' style='font-size:48px;color:red'></i><br>
                        <br>
                        <h5 class="card-title">Pilih Destinasi Wisata</h5>
                        <p class="card-text">Pilih destinasi wisata yang diinginkan, lalu pilih hari dan jam kunjungan.</p>
                    </div>
                    <div class="card-footer text-light" style="background: #1D3283;">
                        Happy Holiday!
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <i class='fas fa-file-alt' style='font-size:48px;color:red'></i><br>
                        <br>
                        <h5 class="card-title">Isi Form Pemesanan</h5>
                        <p class="card-text">Unduh tiket untuk ditunjukkan dan discan oleh petugas loket saat hari kunjungan.</p>
                    </div>
                    <div class="card-header text-light" style="background: #1D3283;">
                        Happy Holiday!
                    </div>
            ...
            <div class="col">
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        <i class='fas fa-ticket-alt' style='font-size:48px;color:red'></i><br>
                        <br>
                        <h5 class="card-title">Cetak Tiket Wisata</h5>
                        <p class="card-text">Pilih destinasi wisata yang diinginkan, lalu pilih hari dan jam kunjungan.</p>
                    </div>
                    <div class="card-footer text-light" style="background: #1D3283;">
                        Happy Holiday!
