...
<head>
    ...
    <title>Air Terjun Coban Pelangi</title>
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/cobanpelangi.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Air Terjun Coban Pelangi</h5>
                        ...
                        <p>Coban Pelangi merupakan salah satu wanawisata yang yang ada di Kabupaten Malang. Air terjun ini berada di ketinggian 1299,5 m di kaki Gunung Semeru arah ke desa Ngadas.dan memiliki terjunan air setinggi kurang lebih 110 m. Suhu udara di kawasan ini berkisar antara 19 - 23 derajat Celcius. Dinamakan Coban Pelangi karena air terjun ini sering membiaskan warna pelangi.

                            Bagi para pendaki Gunung Semeru, air terjun ini tidak asing bagi mereka, karena mobil jeep angkutan umum satu-satunya yang membawa mereka dari pasar Tumpang menuju ke Gunung Bromo akan melewati lokasi ini. Berjarak seklitar 2 km dari desa Gubuk Klakah atau sekitar ± 32 km sebelah timur kota Malang.</p>
                    </div>
