...
<head>
    ...
    <title>Pantai Teluk Asmara</title>
        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/telukasmara.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p>Pantai Teluk Asmara merupakan pantai yang memiliki pesona alam yang tak kalah indah jika dibandingkan dengan pantai-pantai lainnya karena pantai Teluk Asmara dikelilingi oleh gugusan pulau-pulau yang membuatnya semakin menawan dan sayang untuk dilewatkan. Pantai Teluk Asmara memiliki bentuk yang hampir serupa dengan Raja Ampat. Selain itu, pantai ini beroperasi selama 24 jam dengan harga yang sangat terjangkau serta menawarkan objek wisata utamanya yakni snorkeling.</p>
                    </div>
