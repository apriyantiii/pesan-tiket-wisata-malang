        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/selecta.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p>Selecta, adalah tempat peristirahat yang di bangun sejak jaman Belanda, dan terkenal dengan Selecti. Selecta terletak di desa Tulungrejo, Kecamatan Bumiaji, 13 Km dari kota Batu.

                            Dengan luar 20 hektar dan terletak 1100 M dari permukaan laut, Selecta telah ada sejak tahun 1928 dan dibangun oleh seorang Belanda bernama Reyter Dewild. Obyek wisata ini sangat sejuk dan nyaman di kunjungi, dengan kisaran suhu minim 17 derajat celcius setiap harinya.</p>
                    </div>
