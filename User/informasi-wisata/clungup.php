        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/clungup.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Pantai Clungup</h5>
                        ...
                        <p>Pantai Clungup merupakan salah satu pantai di Malang yang terletak di daerah Sumbermanjing. Pantai ini berada di pesisir selatan Pulau Jawa. Pantai ini terletak di daerah Pantai Goa Cina. Meskipun untuk sampai ke tempat ini membutuhkan tenaga yang ekstra tetapi ketika sampai wisatawan dapat menikmati pemandangan alam yang disuguhkan oleh Pantai Clungup. Pantai ini memiliki hamparan pasir putih yang sangat luas dengan ombak laut yang tenang. Tak jarang terdapat ubur-ubur yang sering berenang hingga ke garis pantai.</p>
                    </div>
