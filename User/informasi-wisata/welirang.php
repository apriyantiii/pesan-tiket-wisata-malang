        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/welirang.png" class="card-img-top" alt="...">
                    <div class="card-body"><strong> Gunung Welirang</strong></h5>
                        ...
                        <p>Gunung Welirang adalah sebuah gunung berapi aktif dengan ketinggian 3.156 m dpl yang secara administratif terletak di perbatasan Kota Batu, Kabupaten Pasuruan, dan Kabupaten Mojokerto, Jawa Timur, Indonesia. Gunung Welirang berada dalam pengelolaan Taman Hutan Raya Raden Soerjo.

                            Gunung Welirang bersebelahan dengan Gunung Arjuno, Gunung Kembar I, dan Gunung Kembar II. Puncak Gunung Welirang terletak pada satu punggungan yang sama dengan puncak gunung Arjuno, sehingga kompleks ini sering disebut juga dengan Arjuno-Welirang. Kompleks Arjuno-Welirang sendiri berada di dua gunung berapi yang lebih tua, Gunung Ringgit di timur dan Gunung Lincing di selatan. Area fumarol dengan cadangan belerang ditemukan di sejumlah lokasi pegunungan ini.

                            "Welirang" atau Walirang (nama kunanya) dalam bahasa Jawa berarti belerang. Di sekujur lerengnya ditumbuhi tetumbuhan kawasan hutan Dipterokarp Bukit, hutan Dipterokarp Atas, hutan Montane, dan Hutan Ericaceous atau hutan gunung.</p>
                    </div>
