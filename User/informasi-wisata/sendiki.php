        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/sendiki.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        <h5 class="card-title">Pantai Sendiki</h5>
                        ...
                        <p>Pantai Sendiki merupakan pantai yang terletak di daerah Sumbermanjing. Pantai Sendiki merupakan salah satu pantai yang memiliki banyak wisatawan. Pantai Sendiki memiliki garis pantai yang dipenuhi pasir putih halus yang membentang hingga 77 km dengan pemandangan yang asri, bersih, dan tenang sehingga membuat wisatawan tertarik untuk berkunjung ke pantai ini sekaligus menikmati suasana di area camping ground yang telah disediakan.</p>
                    </div>
