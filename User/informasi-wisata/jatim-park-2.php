        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/jatimpark2.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p>Batu Secret Zoo berdiri di atas lahan seluas 15 hektare dan terdapat enam area di dalamnya.

                            Area tersebut meliputi akuarium, pasar Afrika, fantasy and adventure land, area reptil, tiger land, dan sabana.

                            Selain itu, Batu Secret Zoo juga menawarkan suasana sejuk serta lingkungan yang bersih.

                            Di sisi lain, ada pula Eco Green Park. Sesuai dengan namanya, tempat tersebut dihiasi oleh wahana yang terbuat dari barang-barang bekas.

                            Sebanyak 30 wahana di dalam Eco Green Park, seperti world of parrot, hydroponic, animal farm, eco journey, dan masih banyak lainnya.

                            Jatim Park 2 juga menawarkan Museum Satwa berisi koleksi serangga, patung hewan, dan fosil.</p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="col-md-10">
                            <div class="form-group" action="POST">
                                <label><i class='fas fa-calendar-alt'></i> Harga Weekday</label><br><br>
                                <h2><strong>Rp. 135.000</strong></h2>
                                <label><i class='fas fa-calendar-alt'></i> Harga Weekend</label><br><br>
