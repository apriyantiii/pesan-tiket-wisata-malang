        ...
        <div class="row">
            <div class="col">
                <div class="card" style="width: 50rem;">
                    <img src="../image/jatimpark3.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
                        ...
                        <p>Jatim Park 3 atau Jawa Timur Park 3 merupakan theme park keren yang wajib kamu kunjungi ketika berada di Kota Batu, Jawa Timur. Jatim Park 3 hadir dengan tehnologi yang canggih namun dibalut dengan suasana alam yang sejuk. Pas banget untuk wisata bersama keluarga, karena ramah anak.</p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="col-md-10">
                            <div class="form-group" action="POST">
                                ...
                                <h2><strong>Rp. 130.000</strong></h2>
